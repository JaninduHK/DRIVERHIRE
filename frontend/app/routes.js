...
export default [
  ...
  // /login is driver/admin only; traveller sign-in/sign-up goes straight to
  // Asgardeo's hosted login (SSO_LOGIN_URL in authToken.js) — there's no
  // local landing page for it. /auth/callback is where Asgardeo redirects back.
